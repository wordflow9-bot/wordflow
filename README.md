...
добавление слова вручную и выбор его перевода из базы данных

добавление слова и его перевода с помощью модуля распознавания текста (ocr)

Просмотр своего словаря
